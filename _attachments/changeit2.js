...
function create_db_doc(general_info,desc_info,levels,pails,stratigraphies){
	...
	alert('stratigraphies succeeded');
		return doc;
        ...
        success: function(data){
            ...
            for(i in data.rows){
                ...
                if(data.rows[i].key==key[1]){
                    $("#id_table").append("<tr><td>Start Date</td><td><input class='general_info_updated'/></td></tr><tr><td>End Date</td><td><input class='general_info_updated'/></td></tr><tr><td>Site</td><td>Umayri</td></tr><tr><td>Field</td><td><input class='general_info_updated'/></td></tr><tr><td>Square</td><td><input class='general_info_updated'/></td></tr><tr><td>Code</td><td><input class='general_info_updated'/></td></tr><tr><td>Locus_type</td><td><input class='general_info_updated'/></td></tr><tr><td>Supervisor</td><td><input class='general_info_updated'/></td></tr><tr><td>Designation</td><td><input class='general_info_updated'/></td></tr><tr><td>Reason</td><td><input class='general_info_updated'/></td></tr><tr><td>Top Separability</td><td><input class='general_info_updated'/></td></tr><tr><td>Bottom Separability</td><td><input class='general_info_updated'/></td></tr><tr><td>Interpretation</td><td></td></tr><tr><td>Stratigraphy</td><td><input class='general_info_updated'/></td></tr><tr><td>Locus date</td><td><input class='general_info_updated'/></td></tr><tr><td>Top Plans</td><td><input class='general_info_updated'/></td></tr><tr><td>Draw balks</td><td><input class='general_info_'/></td></tr><tr><td><a href='#' class='next1'>Next</a></td><td></td></tr>");
                }
            }
...
function add_levels_info(){
    ...
    $("#tab3").append("<input type='button' class='add_row' id='table_levels_add_row' value='Add row'/><br/><input type='button' class='print' value='print'/><br/>");
...
function add_stratigraphies_info(){
    ...
    $("#table_stratigraphies_add").append("<tr><td><input class='stratigraphies_added'/></td><td><input class='stratigraphies_added'/></td></td><td><input class='stratigraphies_added'/></td></tr>");   
	$("#tab6").append("<input type='button' class='add_row' id='table_stratigraphies_add_row' value='Add row'/><br/><input type='button' class='print' value='print'/><br/>");
...
function add_pails_info(){
    ...
    $("#table_pails_add").append("<tr><td><input class='pails_added'/></td><td><input class='pails_added'/></td><td><input class='pails_added'/></td><td><input class='pails_added'/></td><td><input class='pails_added'/></td><td><input class='pails_added'/></td><td><input class='pails_added'/></td><td><input class='pails_added'/></td></tr>");
	$("#tab4").append("<input type='button' class='add_row' id='table_pails_add_row' value='Add row'/><br/><input type='button' class='print' value='print'/><br/>");
    ...
    db.view("Opendig_v2/byartifacts",{
        ...
        for(i in data.rows){
            ...
            if(data.rows[i].key==key[1]){
                ...
                $("#tab7").append("<input value='Update information' type='button' id='update'/><br/>");
            }
        }
...
$("#save").live('click', function(event){
	...
	var pails= [ ];
		...
		db.saveDoc(create_db_doc(general_info, desc_info, levels, pails, stratigraphies),{
			success: function(){
